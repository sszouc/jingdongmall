...
public interface CouponService {
     ...
     * @param request          请求参数
     */
    void updateCoupon(Long currentUserId, Integer currentUserRole, Long id, CouponUpdateRequest request);
     ...
     * @param id                优惠券ID
     */
    void deleteCoupon(Long currentUserId, Integer currentUserRole, Long id);
}
